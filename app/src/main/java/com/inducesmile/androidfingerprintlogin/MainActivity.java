        ...
        signInButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isFingerPrint()) {
                    ...
                    Toast.makeText(MainActivity.this, "Fingerprint not available", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void setupToFingerPrint() {
        ...
        identityBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MainActivity.this, getResources().getString(R.string.finger), Toast.LENGTH_LONG).show();
